      ...
      <div class="${PALETTE_CLS}">
        <div class="header">
          <select class="chart-select">
            <option value="comparativeSummary">Análisis de Escenarios (Normal vs. Extras)</option>
            <option value="overallSummary">Resumen General (Continuo)</option>
        ...
        <div class="help-content hidden">
          ...
          <p><strong>Análisis de Escenarios (Normal vs. Extras):</strong> (Solo para simulaciones de Lote Fijo) Compara los resultados de ejecutar el lote en horario normal contra ejecutarlo con horas extras para terminar lo antes posible. Muestra la diferencia en duración total, costo y horas extras generadas.</p>
          <p><strong>Resumen General (Continuo):</strong> (Solo para simulaciones de Proceso Continuo) Muestra las métricas totales más importantes de la simulación, como la duración total en tiempo de calendario, el costo total de la operación y el número de instancias completadas.</p>
