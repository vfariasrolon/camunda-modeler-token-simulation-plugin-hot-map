...
class Heatmap {
  ...
  _init() {
    ...
    const loadTestDataButton = (0,min_dom__WEBPACK_IMPORTED_MODULE_3__.domify)(`<div class="bts-entry" title="Load Hardcoded Test Data">${TestDataIcon('test-data')}</div>`);
    min_dom__WEBPACK_IMPORTED_MODULE_3__.event.bind(loadTestDataButton, 'click', () => this._loadTestData());
  ...
  _loadTestData() {
    ...
    const tasks = allElements.filter(el => (0,bpmn_js_lib_util_ModelUtil__WEBPACK_IMPORTED_MODULE_4__.is)(el, 'bpmn:Task'));
    const process = allElements.find(el => (0,bpmn_js_lib_util_ModelUtil__WEBPACK_IMPORTED_MODULE_4__.is)(el, 'bpmn:Process'));
